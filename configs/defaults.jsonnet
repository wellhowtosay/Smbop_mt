...
local devset_config = {
  cache_suffix :: "val", 
  data_suffix :: "sql_state_tracking/cosql_dev.json",
...
local trainset_config = {
  cache_suffix :: "train",
  data_suffix :: "sql_state_tracking/cosql_train.json",
  limit_instances :: -1,
...
local dataset_path = "cosql_dataset/";
...
local dataset_reader_name = "smbop_cosql";

{
  ...
  "train_data_path": dataset_path + "sql_state_tracking/cosql_train.json",
